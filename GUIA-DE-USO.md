...
**El QR cambia cada 30 segundos.** Es a propósito: así, si alguien le toma una
foto a tu pantalla, esa foto no le sirve para entrar.
...
1. Entra con tu cuenta. Vas directo a **Control de acceso**.
2. Escribe tu puesto arriba a la derecha (*Puerta 1*, *Mostrador*…). Se queda
...
descontada. El número grande son las entradas que le quedan.

- **Recuadro amarillo, "Ya se registró hace un momento"**: la cámara leyó dos
  veces. No se descontó nada de más. Espera unos segundos si de verdad hay que
  cobrar otra entrada.
...
con su historial de movimientos. Si dice "Contabilidad correcta", no falta ni
sobra ninguna entrada. Si alguna vez avisara de diferencias, mira la
**Auditoría** y llama a soporte técnico.
